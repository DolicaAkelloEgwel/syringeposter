...
\caption{Remote working setup: a GiGE camera is facing the syringe, and its feed is streamed through http.}
\vspace{-1.2em}
\end{center}
\end{figure}
\end{posterbox}
...
\vspace{-1em}
\setlength{\fboxrule}{2pt}
\fbox{\includegraphics[width=\textwidth]{images/cycleedm}}
