...
\end{listing}
    \vspace{-1.2em}
    The following tools were used for code quality/cleaniless: \texttt{black}, \texttt{flake8}, \texttt{mypy},
    and \texttt{isort.}
\end{posterbox}
%----------------------------------------------------------------------------------------
%	CYCLING
...
\end{figure}
\begin{multicols}{2}
The cycling behaviour worked by creating a seperate thread for repeatedly sending commands to the syringes.
