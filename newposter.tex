...
%----------------------------------------------------------------------------------------
%
{\includegraphics[height=4em]{images/diamondlogo}} % First university/lab logo on the left
...
{\includegraphics[height=4em]{images/stfclogo}} % Second university/lab logo on the right
...
% \headerbox{Something Else}{name=somethingelse,column=1,row=0,bottomaligned=objectives}{
%}
